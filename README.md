...
> 基于 Electron 的完整学习教程，从入门到实战，循序渐进掌握 Node.js + Web 桌面应用开发。
...
| 章节 | 主题 | Demo |
|------|------|------|
| [第一章](./docs/01-getting-started.md) | 认识 Electron — 入门与环境搭建 | [hello-world](./demos/01-hello-world/) |
| [第二章](./docs/02-architecture.md) | 核心原理 — 进程架构与 IPC 通信 | [ipc-events](./demos/02-ipc-events/) |
| [第三章](./docs/03-frontend-integration.md) | 前端集成 — React + TypeScript | [todo-app](./demos/03-todo-app/) |
| [第四章](./docs/04-backend-development.md) | 主进程开发 — Node.js 后端与数据 | [notebook](./demos/04-notebook/) |
